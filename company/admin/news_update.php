<?php
    ...
    $sql = "UPDATE news SET news_title = '$title', news_img = '$filename', news_content = '$content', news_author = '$author', news_created = '$created' WHERE news.news_id = $id";
    ...
    if ($conn) {
        $sql = "UPDATE news SET news_title = ?, news_img = ?, news_content = ?, news_author = ?, news_created = ? WHERE news.news_id = ?";
