            ...
            <form action="product_type_update.php" method="post" enctype="multipart/form-data">
                <div class="row">
                    ...
                    <div class="col-md-10 mb-3">
                        <input type="text" class="form-control" name="product_type_title" id="" value="<?php echo $row['product_type']?>" required>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12 text-end">
                        <input type="hidden" name="product_type_id" value="<?php echo $row['product_type_id'] ?>">
